...
# Experiment Mode
EXP_MODE = 'HILIC-GINKAN' 

# Current Time
current_time_str = datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S")

# Save Directory
SAVE_DIR = os.path.join(path, 'GOLBAL1215_pernormal_persample_results', EXP_MODE, current_time_str)
...
if __name__ == "__main__":
    ...
    for task_id, csv_path in enumerate(data_files):
        ...
        try:
            ...
            # print(f"Task {task_id}: Stratification failed, using random split.")
